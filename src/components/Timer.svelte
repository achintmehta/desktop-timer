<script>
    ...
    let { message, duration, shape, backgroundColor, progressBarColor, borderRadius, containerWidth, containerHeight, circleRadius, padding, font, messageColor, messagePadding, timerMargin } = TimerConfiguration;
...
<div style=" margin-bottom: {timerMargin}px;">
    <div class="controls">
        {#if message}
        <div class="message-text" style="font-family: {font}; color: {messageColor}; padding: {messagePadding}px;">{message}</div>
        {/if}
